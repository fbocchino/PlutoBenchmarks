 ...
 **************************************************************** */
{
  ...
  f    = ( sin(th)*sin(th) + bc );
    ...
    v[PRS]  = IsentropicPressure(v[RHO]/rho0, p0);
...
/* -----------------------------------------------------------
  ...
  r_reset = MAX(r_reset,1.*(grid->dx[IDIR][IBEG]));
  r_reset = MAX(r_reset,1.*(grid->dx[JDIR][JBEG])); 
  r_reset = MAX(r_reset,1.*(grid->dx[KDIR][KBEG])); 
 /*print("TEST (%f), (%f), (%f), (%f)\n ", r_reset, grid->dx[IDIR][IBEG],grid->dx[JDIR][JBEG],grid->dx[KDIR][KBEG]);*/
