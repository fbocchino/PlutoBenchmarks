...
/* -------------------------------------------
   ...
   ------------------------------------------- */
    ...
    else if ( r < 1.0)                grad[k][j][i] *= (m_level <= 3 ? 1.0:0.0);
    else if ( r < 2.0)                grad[k][j][i] *= (m_level <= 2 ? 1.0:0.0);
    else if ( r < 3.0)                grad[k][j][i] *= (m_level <= 1 ? 1.0:0.0);
    else if ( r < 8.0)               grad[k][j][i] *= (m_level <= 0 ? 1.0:0.0);
    else                               grad[k][j][i] *= 0.0;
